...
An academic machine-learning project that compares supervised classifiers for predicting corporate bankruptcy from financial indicators.

## Overview

The workflow prepares a mixed financial dataset, inspects class distribution, handles class imbalance with random undersampling, and evaluates candidate classifiers across stratified folds.
...
~~~bash
git clone https://github.com/Stelioszapa/bankruptcy-prediction-classification.git
cd bankruptcy-prediction-classification
python -m venv .venv
source .venv/bin/activate
pip install -r requirements.txt
python train.py --data data/Dataset2Use_Assignment1.xlsx --output results
~~~
...
7. Export fold-level metrics and selected hyperparameters to CSV.

## Notes

- This repository is a portfolio presentation of an academic project, not financial advice.
- No original dataset is published.
